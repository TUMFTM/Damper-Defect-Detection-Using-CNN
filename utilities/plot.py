    ...
    if '2D' in tensor_name:
        for cnt_kernel in range(0, x.shape[3]):
            ...
            for cnt_signal in range(0, x.shape[2]):
                ...
                axes[cnt_row, cnt_col].imshow(x[:, :, cnt_signal, cnt_kernel], vmin=0, vmax=v_max, cmap='gray_r')
...
if __name__ == '__main__':
    # plot_kernels(path='W:\\Projekte\\Fahrwerkdiagnose\\Datenanalyse\\CNN\\results\\2019_10_31_09h_10_ArchVar_Detrend_cv5\\e_13_k_016_cv5\\fold_0', tensor_name='CNN_Model/Stage_0/conv_0/conv1D/kernel:0')
    plot_kernels(
        # path='W:\\Projekte\\Fahrwerkdiagnose\\Datenanalyse\\CNN\\results\\2019_11_08_19h_21_Archvar_FFT_k16_addc0_2_e1_63_pool1_32\\addc_0_e_063_poolingsize_001_cv5\\fold_0',
        # path='W:\\Projekte\\Fahrwerkdiagnose\\Datenanalyse\\CNN\\results\\2019_11_08_19h_21_Archvar_FFT_k16_addc0_2_e1_63_pool1_32\\addc_0_e_001_poolingsize_001_cv5\\fold_0',
        # path='W:\\Projekte\\Fahrwerkdiagnose\\Datenanalyse\\CNN\\results\\2019_11_08_19h_22_Archvar_Detrend_k16_addc0_2_e1_63_pool1_32\\addc_0_e_015_poolingsize_016_cv5\\fold_0',
        # path='W:\\Projekte\\Fahrwerkdiagnose\\Datenanalyse\\CNN\\results\\2019_11_19_15h_37\\addc_0_e_001_poolingsize_001_cv5\\fold_0',
        path='W:\\Projekte\\Fahrwerkdiagnose\\Datenanalyse\\CNN\\results\\2019_11_08_19h_20_Archvar_STFT_e3_63_k16_pool2_16\\addc_0_e_015_poolingsize_001_cv5\\fold_0',
        tensor_name='CNN_Model/Stage_0/conv_0/conv2D/kernel:0',
        export2tikz=True, save_fig=True, show_fig=False)
